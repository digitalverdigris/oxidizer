...
cube::cube(shader &a_shader, int r_width, int r_height, glm::vec3 a_pos, glm::vec3 a_color)
    : c_shader(a_shader), render_width(r_width), render_height(r_height), pos(a_pos), color(a_color)
{
